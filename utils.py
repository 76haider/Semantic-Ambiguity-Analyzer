...
def read_text_file(uploaded_file):
    ...
    return content[:2000]  # Limit to reasonable size
...
def create_ambiguity_chart(results_dict):
    ...
    ax.set_xlabel("Ambiguity Count", fontsize=11, color="#333333")
    ax.set_title("Semantic Ambiguity Analysis", fontsize=14,
...
def create_comparison_chart(results_a, results_b, label_a, label_b):
    ...
    ax.set_ylabel("Ambiguity Count", fontsize=11, color="#333333")
    ax.set_title("Comparison: Semantic Ambiguity", fontsize=14,
                 fontweight="bold", color="#2C3E50", pad=15)
